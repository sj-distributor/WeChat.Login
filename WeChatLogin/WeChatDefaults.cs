namespace WeChatLogin
{
    public class WeChatDefaults
    {
        ...
        /// <summary>
        /// 第一步，获取AuthorizationCode地址，适用于微信客户端外的网页登录
        /// </summary>
        public static readonly string WebAuthorizationEndpoint = "https://open.weixin.qq.com/connect/qrconnect";

        /// <summary>
        /// 第一步，获取AuthorizationCode地址，适用于微信客户端内的网页登录（在微信内部访问登录）
        /// </summary>
        public static readonly string MobileAuthorizationEndpoint = "https://open.weixin.qq.com/connect/oauth2/authorize";
